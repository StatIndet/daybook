...
资源来源不确定时统一记录为 `Source: project owner provided`。
...
| Material Symbols | `static/fonts/material-symbols/` | 导航与操作图标 | project owner provided |
| Social icons | `static/icons/social/` | 首页社交链接图标 | project owner provided |
| shelby.jpg | `static/images/avatar/shelby.jpg` | 首页和 side-nav 头像 | project owner provided |
