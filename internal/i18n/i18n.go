...
var dictionary = map[string]map[string]string{
	"zh_CN": {
		...
		"action.bottom":       "直达底部",
		"action.theme":        "切换主题",
		"action.palette":      "切换暖色配色",
		"action.rss":          "RSS订阅",
		"action.reader":       "阅读模式",
		"action.exit_reader":  "退出阅读模式",
		"tooltip.search":      "搜索",
		"tooltip.tags":        "标签",
		"tooltip.theme":       "切换主题",
		"tooltip.palette":     "切换暖色配色",
	...
	"en_US": {
		...
		"action.theme":        "Theme",
		"action.palette":      "Warm palette",
		"action.rss":          "RSS",
		"action.reader":       "Reader mode",
		"action.exit_reader":  "Exit reader mode",
		"tooltip.search":      "Search",
		"tooltip.tags":        "Tags",
		"tooltip.theme":       "Toggle Theme",
		"tooltip.palette":     "Toggle warm palette",
